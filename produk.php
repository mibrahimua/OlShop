					...
					<div class="panel panel-primary">
						...
						<div class="panel-footer" align="left">
							...
							<h4><?php echo "Rp ".number_format($data['harga'] , 0 , "" , '.') . ",-"; ?> 
								<span class="badge bg-1">Save <?php echo $data['diskon']; ?>%</span></h4>
								<a class="add_to_cart_button" href="proses_tambahkrjg.php?id=<?php echo $data['kd_brg']; ?>">Tambah ke Keranjang</a>
						</div>
					</div>
				</div>
			</div>
