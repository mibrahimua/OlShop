...
<link rel="stylesheet" type="text/css" href="lib/css/detail.css" media="all">
	...
	<div class="product">
		<div class="container">
			<div class="col-md-3 product-price">
				...
				<?php  
				$query = "SELECT * FROM barang ORDER BY Rand() LIMIT 3";
			...
			<?php 
			$query = "SELECT * FROM barang WHERE kd_brg='$_GET[kd_brg]'";
			 ...
			 <div class="col-md-9 product-price1">
			 	...
			 	<div class="col-md-7 single-top-in simpleCart_shelfItem">
			 		<div class="single-para">
			 			...
			 			<button type="button" class="btn btn-success" data-toggle="collapse" data-target="#spesifikasi">Spesifikasi</button>
			 			<div id="spesifikasi" class="collapse out">
			 				<p align="justify"><?php echo $data['spek'];  ?></p>
			 			</div>
			 				<ul class="tag_men">
			 					<li><span>Stok &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
			 						<span class="katt">: <?php echo $data['stok'] ?></span></li>
			 					<li><span>Diskon &nbsp;</span>
			 						<span class="katt">: <?php echo $data['diskon'] ?></span></li>
			 					<li><span>Kategori</span>
			 						<span class="katt">: <?php echo $data['kategori'] ?></span></li>
			 				</ul>
			 				<a href="proses_tambahkrjg.php?id=<?php echo $data['kd_brg']; ?>" class="add-cart item_add"> ADD TO CART</a>
			 		</div>
			 	</div>
			 </div>
		</div>
